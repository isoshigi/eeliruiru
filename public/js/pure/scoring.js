...
export function getRankTitle(score, burned) {
    ...
    if (score >= 3000)
        return "🍳 一人前の調理人";
    if (burned >= 4)
        return "⚠️ ボヤ騒ぎを起こした危険人物";
    return "見習いシェフ";
}
/** 15コンボごとにフィーバー。旧実装: combo % 15 === 0 */
export function shouldTriggerFever(combo) {
