...
export function updateWokUI() {
    const w = gameState.wok;
    if (!els.cookProgress || !els.wokContainer || !els.steamEffect || !els.wokBadge || !els.wokEmoji || !els.wokStatusText || !els.pullBonusText)
        return;
